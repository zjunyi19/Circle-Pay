...
SWIFT_CLASS("_TtC3try11AppDelegate")
...
SWIFT_CLASS("_TtC3try24MoneySpentViewController")
@interface MoneySpentViewController : UIViewController
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified spendingTxt;
...
- (IBAction)recordingBtn:(id _Nonnull)sender;
...
SWIFT_CLASS("_TtC3try24MoneyTrackViewController")
@interface MoneyTrackViewController : UIViewController
...
SWIFT_CLASS("_TtC3try13SceneDelegate")
...
SWIFT_CLASS("_TtC3try23SetBudgetViewController")
@interface SetBudgetViewController : UIViewController
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified budgetTxt;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified warningLabel;
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified EndDateTxt;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified warninglabel2;
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC3try14ViewController")
